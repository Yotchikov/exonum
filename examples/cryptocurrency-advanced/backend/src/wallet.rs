...
pub struct Wallet {
    ...
    pub balance: u64,
    /// Current sreezed balance of the wallet.
    pub f_balance: u64,
...
impl Wallet {
    ...
    /// Returns a copy of this wallet with uploaded freezed balance. 
    pub fn set_freezed_balance(self, f_balance: u64, history_hash: &Hash) -> Self {
        Self::new(
            self.owner,
            &self.name,
            self.balance,
